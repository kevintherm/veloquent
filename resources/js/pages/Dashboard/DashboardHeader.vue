...
<template>
    <header class="h-16 border-b bg-card flex flex-wrap items-center justify-between px-8 shrink-0">
        <div class="flex items-center gap-4">
            <h1 class="text-xl font-semibold hidden lg:block">{{ collectionName || "Collection" }}</h1>
