...
const fetchOrphans = async () => {
  ...
  try {
    const response = await axios.get("schema/orphans");
...
const fetchCorrupt = async () => {
  ...
  try {
    const response = await axios.get("schema/corrupt");
...
const handleCleanOrphan = async (tableName) => {
  ...
  cleaning.value = true;
  try {
    await axios.delete(`schema/orphans/${encodeURIComponent(tableName)}`);
...
const handleCleanAll = async () => {
  ...
  cleaning.value = true;
  try {
    await axios.delete("schema/orphans");
...
const handleRecover = async (job) => {
  ...
  try {
    await axios.post(`collections/${encodeURIComponent(collectionId)}/recover`);
