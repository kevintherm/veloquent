...
const fetchTemplate = async (action) => {
  ...
  try {
    const response = await axios.get(`collections/${collectionId}/email-templates/${action}`);
...
const saveTemplate = async (action, id = null, quiet = false) => {
  ...
  try {
    await axios.put(`collections/${collectionId}/email-templates/${action}`, {
...
const fetchCollectionInfo = async () => {
  ...
  try {
    const response = await axios.get(`collections/${encodeURIComponent(identifier)}`);
...
const fetchProviders = async () => {
  ...
  try {
    const response = await axios.get(`collections/${fetchedCollection.value.id}/oauth-providers`);
...
const saveProviderConfig = async () => {
  ...
  const url = isNew
    ? `collections/${fetchedCollection.value.id}/oauth-providers`
    : `collections/${fetchedCollection.value.id}/oauth-providers/${editingProvider.value.id}`;
...
const deleteProviderConfig = async (providerId) => {
  ...
  try {
    await axios.delete(`collections/${fetchedCollection.value.id}/oauth-providers/${providerId}`);
...
const handleDelete = async () => {
  ...
  try {
    await axios.delete(`collections/${encodeURIComponent(fetchedCollection.value.id)}`);
...
const handleTruncate = async () => {
  ...
  try {
    await axios.delete(`collections/${encodeURIComponent(fetchedCollection.value.id)}/truncate`);
...
const handleRecover = async () => {
  ...
  try {
    await axios.post(`collections/${encodeURIComponent(schemaCorrupt.value.collection_id)}/recover`);
