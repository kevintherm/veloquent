...
use Veloquent\Core\Http\Requests\Auth\ConfirmEmailChangeRequest;
use Veloquent\Core\Http\Requests\Auth\ConfirmEmailVerificationRequest;
use Veloquent\Core\Http\Requests\Auth\ConfirmPasswordResetRequest;
