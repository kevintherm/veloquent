...
namespace Veloquent\Core\Domain\RuleEngine\Adapters;

use Veloquent\Core\Domain\RuleEngine\Contracts\FieldResolverAdapter;
use Veloquent\Core\Domain\RuleEngine\Contracts\QueryFieldAdapter;
